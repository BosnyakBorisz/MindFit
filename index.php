...
<body>
  ...
  <main>
        ...
        <div class="container-fluid w-75 d-flex flex-column">
            ...
            <div class="row pt-5">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6" id="stresszkezeles_box4">
                    ...
                    <h1 class="index_sokcim"><a  class="link" href="stresszkezeles.php">Stresszkezelések</a> </h1>
    ...
    <div id="privacy-popup">
        ...
        <a href="adatkezeles.html" class="privacy-link" target="_blank">Adatvédelmi szabályzat</a>
