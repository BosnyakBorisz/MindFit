...
<body>
    ...
    <main>
        <div class="container-fluid my-4">
            <h1 class="my-4">Üdvözlünk <?php echo htmlspecialchars($_SESSION["username"]); ?>!</h1>
        ...
        <div class="container my4">
            <section class="calories">
                <div class="row justify-content-center mb-4">
                    ...
                    <div class="text-center">
                        <input class="form-control mb-2 w-40 mx-auto" type="number" id="calorieInput" value="0" style="width: 15rem;">
                        <button class="btn" onclick="addCalories()" style="background-color: var(--h); color: white; width: 10rem; height: 3rem; font-size:1.2rem;">Hozzáadás</button>
                    </div>
                    </div>
                </div>
            </section>
            ...
            <section id="steps-and-water">
                <div class="row justify-content-center g-4 mb-4">
                    <div class="col-lg-5 col-md-5 col-10 mx-1 steps p-3 rounded-2">
                        ...
                        <input class="form-control mb-2" type="number" id="stepsInput" value="0" style="width: 15rem;">
                    ...
                    <div class="col-lg-5 col-md-5 col-10 mx-1 water p-3 rounded-2">
                        ...
                        <div class="d-flex align-items-center mb-2">
                          <input class="form-control me-2" type="number" id="vizinput" value="0" style="width: 15rem;">
                          <label>ml</label>
                        </div>      
                    ...
                    <!--
                    <div class="col-lg-5 col-md-5 col-12 mx-1 water p-3 rounded-2">
                        <h2>Víz</h2>
                        <h4 id="waterGoal">Cél: </h4>
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                            <div>
                                ...
                                <button class="btn mb-3" onclick="vizHozzaAd()" style="background-color: var(--h); color: white; width: 10rem; height: 3rem; font-size:1.2rem;">Hozzáadás</button>
                            </div>
            ...
            <section class="row justify-content-center mt-4">
                <div class="col-10 w-plan-bg p-3 rounded-2 text-center">
                <h2>Edzés</h2>
                <div class="d-flex justify-content-center flex-wrap" onclick="window.location.href='http://localhost/mindfit/MindFit/edzesterv.php'" style="cursor: pointer;">
                    <img id="izomterkep1" class="m-2" style="width: 45%; max-width: 250px;" src="" alt="">
                    <img id="izomterkep2" class="m-2" style="width: 45%; max-width: 250px;" src="" alt="">
                </div>
                </div>
            </section>
        </div>
